...
const App: React.FC = () => {
    ...
    const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            console.error(err);
            alert("Upload failed. Ensure files are valid CSV or XLSX format.");
        } finally {
                    ...
                    <section className="grid grid-cols-1 xl:grid-cols-12 gap-6">
                        ...
                        <div className="xl:col-span-8">
                            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col h-full">
                                ...
                                {tables.length === 0 && (
                                    <p className="mt-3 text-[10px] font-bold text-amber-600 bg-amber-50 px-3 py-1.5 rounded-md border border-amber-100 flex items-center gap-2">
